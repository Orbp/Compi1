...
public class Ventana extends javax.swing.JFrame {
     ...
     */
    Conexion hilo = new Conexion("Servidor");
    public Ventana() {
        initComponents();
        jScrollPane6.getVerticalScrollBar().setModel(jScrollPane1.getVerticalScrollBar().getModel());
        jScrollPane6.getVerticalScrollBar().setPreferredSize(new Dimension(0,0));
        jScrollPane6.getHorizontalScrollBar().setPreferredSize(new Dimension(0,0));
        hilo.setTextarea(jTextArea1, jTextField1);
        hilo.setTabla(jTable1);
        hilo.start();
        ...
        //barra2.setPreferredSize(new Dimension(0, 0));
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tipo", "Error", "Columna", "Fila", "Clase", "Proyecto"
            }
        ) {
